...
def mimaSettings(module: String): Seq[Setting[_]] =
  mimaDefaultSettings ++ Seq(
    ...
    mimaBinaryIssueFilters ++= Seq(
      ProblemFilters.exclude[IncompatibleSignatureProblem]("cron4s.expr.CronExpr.unapply"),
      ProblemFilters.exclude[IncompatibleSignatureProblem]("cron4s.expr.ops#*.*"),
      ProblemFilters.exclude[IncompatibleSignatureProblem]("cron4s.parsing.CronParser.*"),
      ProblemFilters.exclude[IncompatibleSignatureProblem]("cron4s.validation.ops#validate.*"),
      ProblemFilters.exclude[IncompatibleSignatureProblem]("cron4s.validation.NodeValidator.*"),
      ProblemFilters.exclude[IncompatibleSignatureProblem]("cron4s.validation.LowPriorityNodeValidatorInstances.*"),
      ProblemFilters.exclude[IncompatibleSignatureProblem]("cron4s.expr.*.*"),
      ProblemFilters.exclude[IncompatibleSignatureProblem]("cron4s.datetime.PredicateReducer#asPredicate.*"),
      ProblemFilters.exclude[IncompatibleSignatureProblem]("cron4s.datetime.Stepper#stepPerNode.*"),
      // ScalaTest incompatibilities
      ProblemFilters.exclude[IncompatibleResultTypeProblem]("cron4s.testkit.DateTimeCronTestKit.*"),
      ProblemFilters.exclude[IncompatibleResultTypeProblem]("cron4s.testkit.IsDateTimeTestKit.*"),
      ProblemFilters.exclude[IncompatibleResultTypeProblem]("cron4s.testkit.DateTimeNodeTestKit.*"),
      ProblemFilters.exclude[IncompatibleResultTypeProblem]("cron4s.testkit.DateTimeCronTestKit.*"),
      ProblemFilters.exclude[IncompatibleSignatureProblem]("cron4s.testkit.DateTimeNodeTestKit#*.*"),
      ProblemFilters.exclude[IncompatibleSignatureProblem]("cron4s.testkit.DateTimeCronTestKit.*"),
      ProblemFilters.exclude[IncompatibleSignatureProblem]("cron4s.testkit.gen.NodeGenerators.*"),
      ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("cron4s.testkit.Cron4sLawSuite.*"),
      ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("cron4s.testkit.SlowCron4sLawSuite.*"),
      ...
      ProblemFilters.exclude[MissingTypesProblem]("cron4s.testkit.Cron4sLawSuite"),
      ProblemFilters.exclude[MissingTypesProblem]("cron4s.testkit.SlowCron4sLawSuite"),
      ProblemFilters.exclude[IncompatibleMethTypeProblem]("cron4s.testkit.DateTimeNodeTestKit.*"),
      ProblemFilters.exclude[IncompatibleMethTypeProblem]("cron4s.testkit.DateTimeCronTestKit.*"),
      ProblemFilters.exclude[IncompatibleMethTypeProblem]("cron4s.testkit.IsDateTimeTestKit.*"),
    )
  )
...
addCommandAlias(
  "binCompatCheck",
  Seq("coreJVM", "testkitJVM", "joda", "circeJVM", "declineJVM", "doobie")
    .map(module => s"$module/mimaReportBinaryIssues")
    .mkString(";")
)
addCommandAlias(
  "validateJVM",
